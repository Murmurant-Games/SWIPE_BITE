...
LIST item_name = exit, sword, spear, axe, club, dagger, trout, carp, sardine, toe, multitool, sealant, vac_pump, emergency_kit, CO2_filter, dust_mask, light_battery, flashlight,heat_scanner,industrial_lubricant
