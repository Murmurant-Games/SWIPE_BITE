...
LIST traitPERSONALITY = sincere, ruthless, charm, responsible, rebellious, resourceful
LIST traitPOS = sincere, ruthless, charm, responsible, rebellious, resourceful // Respond positively to / is buffed by
LIST traitNEG = sincere, ruthless, charm, responsible, rebellious, resourceful // Respond negatively to / is debuffed by
...
VAR playerCHARM = 1
VAR playerRESPONSIBLE = 1
VAR playerREBELLIOUS = 1
VAR playerRESOURCEFUL = 1
